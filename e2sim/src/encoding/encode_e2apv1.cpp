...
void encoding::generate_e2apv1_setup_request_parameterized(E2AP_PDU_t *e2ap_pdu, std::vector<ran_func_info> all_funcs, uint8_t * gnb_id, uint8_t * plmn_id) {
    ...
    // Add CU-UP ID to E2Node ID 0738
    //e2gnb->gNB_CU_UP_ID = (E2AP_IEs_GNB_CU_UP_ID_t*)calloc(1, sizeof(E2AP_IEs_GNB_CU_UP_ID_t));
    //e2gnb->gNB_CU_UP_ID->buf = (uint8_t*)calloc(1, 1);
    //e2gnb->gNB_CU_UP_ID->buf[0] = 0x01;  // 테스트용 임의 값
    //e2gnb->gNB_CU_UP_ID->size = 1;
    //e2gnb->gNB_CU_UP_ID->bits_unused = 0;
